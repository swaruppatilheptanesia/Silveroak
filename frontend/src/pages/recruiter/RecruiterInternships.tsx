...
export default function RecruiterInternships() {
  ...
  return (
    <DashboardLayout
      ...
      subtitle="Live company-scoped view of internship records linked to your organization"
    >
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card><CardContent className="p-4 flex items-center gap-3"><GraduationCap className="h-5 w-5 text-primary" /><div><p className="text-2xl font-semibold">{totalQuery.data?.pagination.total ?? 0}</p><p className="text-sm text-muted-foreground">Total interns</p></div></CardContent></Card>
          ...
          <CardContent className="p-0">
            {internshipsQuery.isLoading ? (
              ...
              <EmptyState
                ...
                description="No internship records matched your company scope and filters."
                className="py-16"
              />
            ) : (
                    ...
                    {internships.map((internship) => {
                      ...
                      return (
                        <TableRow key={internship.id}>
                          ...
                          <TableCell>
                            <div>
                              <p className="font-medium text-foreground">{internship.role}</p>
